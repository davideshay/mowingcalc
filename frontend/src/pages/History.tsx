import { useMowEvents, useGrowthHistory, useAlgorithmHistory } from '../hooks/useApi';
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left py-2 px-4">Growth (mm)</th>
              ...
              <tbody>
                {events.map((e: any) => (
                  <tr key={e.id} className="border-b border-gray-100">
                    ...
                    <td className="py-2 px-4">{e.growth_at_trigger?.toFixed(1) || '-'}</td>
              ...
              <tbody>
                {algoHistory.map((r: any) => (
                  <tr key={r.id} className="border-b border-gray-100">
                    ...
                    <td className="py-2 px-4">{r.growth_estimate?.toFixed(1) || '-'}</td>
