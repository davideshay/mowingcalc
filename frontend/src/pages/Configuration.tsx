...
import { Card, CardContent, Typography, Button, Box, Stack, Grid, CircularProgress, Divider, Alert } from '@mui/material';
...
export function Configuration() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, pb: 12 }}>
      {/* Sticky Header */}
      <Box sx={{ position: 'sticky', top: 0, zIndex: 50, bgcolor: 'background.paper', borderBottom: '1px solid', borderColor: 'divider', py: 2, boxShadow: 1 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'spaceBetween', flexWrap: 'wrap', gap: 2 }}>
          <Box>
            <Typography variant="h4" component="h1">Configuration</Typography>
            <Typography variant="body2" color="text.secondary">Edit all mowing scheduler parameters</Typography>
          </Box>
      ...
      {!draft && <Card><CardContent><Typography color="text.secondary">Loading...</Typography></CardContent></Card>}
